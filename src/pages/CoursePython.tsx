                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-6 md:space-y-8 relative z-10">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="relative group/input">
                            <School size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors" />
                            <input
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="relative group/input">
                            <Target size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors" />
                            <input
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="relative group/input">
                            <Calendar size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors" />
                            <input
                              type="date" id="dob"
                              value={formData.dob} onChange={(e) => setFormData({ ...formData, dob: e.target.value })}
                              className="w-full pl-12 pr-10 py-4 bg-slate-50/50 hover:bg-slate-50 focus:bg-white border border-slate-200 focus:border-indigo-500 focus:ring-0 outline-none rounded-none text-sm md:text-base text-slate-900 font-semibold transition-all duration-300 shadow-sm text-slate-700"
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="relative group/input">
                            <Award size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors" />
                            <input
                        ...
                        <div className="flex flex-col gap-2 md:col-span-2">
                          ...
                          <div className="relative group/input">
                            <Hash size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-500 transition-colors" />
                            <input
